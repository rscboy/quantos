            ...
            <div className="overflow-y-auto p-6 flex-1 text-sm text-text-2 leading-relaxed space-y-4">
              {activeTab === 'terms' ? (
                <>
                  ...
                  <p><strong>4. Linking to this Web Site.</strong> You may provide links only to the homepage of this Web Site, provided (a) you do not remove or obscure, by framing or otherwise, any portion of the homepage, including its advertisements, the terms of use, the copyright notice, or other notices on this Site, (b) you give Provider notice of such link by sending an e-mail to support@myfedplan.us and (c) you discontinue providing links to this Web Site if requested by Provider. If you wish to provide links to a section within this Web Site, you should forward your request to Provider at support@myfedplan.us and Provider will notify you if permission is granted, and if so the terms and conditions of the permission.</p>
                  ...
                  <p><strong>8. Registration.</strong> Certain sections of this Web Site require you to register. If registration is requested, you agree to provide Provider with accurate and complete registration information. It is your responsibility to inform Provider of any changes to that information. Each registration is for a single individual only, unless specifically designated otherwise on the registration page. Provider does not permit a) anyone other than you to use the sections requiring registration by using your name or password; or b) access through a single name being made available to multiple users on a network or otherwise. You are responsible for preventing such unauthorized use. If you believe there has been unauthorized use, you must notify Provider immediately by emailing support@myfedplan.us</p>
