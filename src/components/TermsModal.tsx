          ...
          >
            ...
            <div className="overflow-y-auto p-6 flex-1 text-sm text-text-2 leading-relaxed space-y-4">
              {activeTab === 'terms' ? (
                ...
                <>
                  <h3 className="text-lg font-bold text-text mb-4">MyFedPlan Privacy Statement</h3>
                  ...
                  This Notice applies only to the information collected by MyFedPlan from the users of our Web site or a private label site created by MyFedPlan. It does not apply to information collected by MyFedPlan in any other way, including offline.</p>
                  ...
                  <p>Privacy Information Manager, c/o MyFedPlan, 185 Lookout Dr. Dayton, OH 45419.</p>
                </>
              )}
            </div>
