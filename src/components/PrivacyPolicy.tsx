    ...
    <div className="max-w-4xl mx-auto px-6 py-16 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-border p-8 md:p-12">
        ...
        <div className="prose prose-blue max-w-none text-text-2 text-sm leading-relaxed space-y-4">
          ...
          <h2 className="text-lg font-bold text-text mt-8 mb-4">Advertising, Cookies, and Google AdSense</h2>
          <p>MyFedPlan may use Google AdSense and other advertising partners to display ads. Third-party vendors, including Google, may use cookies to serve ads based on your prior visits to this web site and other web sites.</p>
          <p>Google and its partners may use cookies for ad personalization, reporting, and frequency management. You can manage ad personalization preferences through Google Ads Settings and can learn more about how Google uses information from sites or apps that use its services through Google policy resources.</p>
          <p>We may also use analytics cookies and similar technologies to understand traffic and improve site performance. By continuing to use our site, you consent to our use of cookies as described in this Privacy Statement and our Cookie Policy.</p>
