...
export function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 animate-in fade-in duration-300">
      <SEO 
        title="Terms of Service | MyFedPlan"
        description="Terms and conditions for using MyFedPlan calculators and services."
      />
      <div className="bg-white rounded-xl shadow-sm border border-border p-8 md:p-12">
        <h1 className="font-serif text-3xl md:text-4xl text-navy mb-8">Terms of Service</h1>
        <div className="prose prose-blue max-w-none text-text-2 text-sm leading-relaxed space-y-4">
          <p className="font-semibold text-text">YOUR USE OF THIS WEB SITE CONSTITUTES YOUR AGREEMENT TO BE BOUND BY THESE TERMS AND CONDITIONS OF USE.</p>
          <p>This Web site, including all of its features and content (the “Web Site”) is a service made available by MyFedPlan or its affiliates (“Provider”) and all content, information, services and software ordered or provided on or through this Web Site (“Content”) may be used solely under the following terms and conditions (“Terms of Use”).</p>
          
          <h2 className="text-lg font-bold text-text mt-8 mb-4">1. Limitations on Use</h2>
          ...
          <h2 className="text-lg font-bold text-text mt-8 mb-4">2. Web Site Limited License</h2>
          <p>As a user of this Web Site you are granted a nonexclusive, nontransferable, revocable, limited license to access and use this Web Site and Content in accordance with these Terms of Use. Provider may terminate this license at any time for any reason.</p>
          
          <h2 className="text-lg font-bold text-text mt-8 mb-4">3. Not Financial Advice</h2>
          ...
          <h2 className="text-lg font-bold text-text mt-8 mb-4">4. Linking to this Web Site</h2>
          <p>You may provide links only to the homepage of this Web Site, provided (a) you do not remove or obscure, by framing or otherwise, any portion of the homepage, including its advertisements, the terms of use, the copyright notice, or other notices on this Site, (b) you give Provider notice of such link by sending an e-mail to support@myfedplan.com and (c) you discontinue providing links to this Web Site if requested by Provider. If you wish to provide links to a section within this Web Site, you should forward your request to Provider at support@myfedplan.com and Provider will notify you if permission is granted, and if so the terms and conditions of the permission.</p>
          
          <h2 className="text-lg font-bold text-text mt-8 mb-4">5. Intellectual Property Rights</h2>
          ...
          <p>Copyright law protects materials available in this Web site. Copyright © 2026 MyFedPlan. All rights reserved.</p>
